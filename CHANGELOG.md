...
- [eas-cli] Add `eas submit:view`, `eas submit:retry`, and `eas submit:cancel` commands. ([#XXXX](https://github.com/expo/eas-cli/pull/XXXX) by [@brentvatne](https://github.com/brentvatne))
