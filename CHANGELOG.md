...
- Add `eas account:usage` command for viewing account usage and billing estimates. ([#3334](https://github.com/expo/eas-cli/pull/3334) by [@EvanBacon](https://github.com/EvanBacon))
