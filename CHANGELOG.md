...
- [eas-cli] Add `eas submit:list`, `eas submit:view`, `eas submit:retry`, and `eas submit:cancel` commands; list and view include the runtime version and fingerprint of the submitted build. ([#4132](https://github.com/expo/eas-cli/pull/4132), [#4134](https://github.com/expo/eas-cli/pull/4134) by [@brentvatne](https://github.com/brentvatne))
- [eas-cli] Add `eas submit:status` command showing the live App Store version, TestFlight build states, and Google Play track state, cross-referenced with EAS submissions. ([#XXXX](https://github.com/expo/eas-cli/pull/XXXX) by [@brentvatne](https://github.com/brentvatne))
