...
- [eas-cli] Bump transitive GraphQL codegen dependencies to use a patched `immutable` version. ([#3972](https://github.com/expo/eas-cli/pull/3972) by [@szdziedzic](https://github.com/szdziedzic))
