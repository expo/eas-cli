...
- Make sure that all links in messages are clickable, if used terminal supports that. ([#1591](https://github.com/expo/eas-cli/pull/1591) by [@Simek](https://github.com/Simek))
