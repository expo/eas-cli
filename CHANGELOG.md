...
- [build-tools] Install mitmproxy and start serve-sim with `--network-capture` when a simulator session requests network capture. ([#4300](https://github.com/expo/eas-cli/pull/4307) by [@gwdp](https://github.com/gwdp))
