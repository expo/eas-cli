...
- `"credentialsSource": "auto"` is now deprecated. The option gets converted to `"credentialsSource": "remote"`. ([#345](https://github.com/expo/eas-cli/pull/345) by [@dsokal](https://github.com/dsokal))
