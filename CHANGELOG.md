...
- [build-tools] Record iOS Simulator sessions through serve-sim using one framebuffer capture and a dedicated hardware encoder. ([#4474](https://github.com/expo/eas-cli/pull/4474) by [@gwdp](https://github.com/gwdp))
