...
- [steps] Support local composite functions (`uses: ./...`) in hook steps. ([#4062](https://github.com/expo/eas-cli/pull/4062) by [@sswrk](https://github.com/sswrk))
...
- [eas-cli] Validate local composite functions referenced from workflow job hooks before publishing a workflow. ([#4064](https://github.com/expo/eas-cli/pull/4064) by [@sswrk](https://github.com/sswrk))
