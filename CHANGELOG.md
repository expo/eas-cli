...
- [eas-cli] Stop creating `CLAUDE.md` in new apps; use `AGENTS.md` for agent instructions. ([#XXXX](https://github.com/expo/eas-cli/pull/XXXX) by [@davidmokos](https://github.com/davidmokos))
