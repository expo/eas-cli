...
- [eas-cli] Stop spinners from printing a new line on every frame after the terminal gets narrower. ([#TBD](https://github.com/expo/eas-cli/pull/TBD) by [@brentvatne](https://github.com/brentvatne))
