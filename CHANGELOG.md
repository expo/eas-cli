...
- [eas-cli] Add optional current-project and build-profile metadata to local uploads. ([#4459](https://github.com/expo/eas-cli/pull/4459) by [@mchisolm0](https://github.com/mchisolm0))
