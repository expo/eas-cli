...
- [build-tools] Add EAS functions for recording iOS Simulator sessions and uploading them as device run session artifacts. ([#3994](https://github.com/expo/eas-cli/pull/3994) by [@sjchmiela](https://github.com/sjchmiela))
