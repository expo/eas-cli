...
const envGraphQLValidatorNames = {
  apollo: (0, _lodash2.default)(
    allGraphQLValidatorNames,
    'KnownFragmentNames',
    'NoUnusedFragments', // `graphql`@15
    'KnownFragmentNamesRule',
    'NoUnusedFragmentsRule'
  ),
  lokka: (0, _lodash2.default)(
    allGraphQLValidatorNames,
    'KnownFragmentNames',
    'NoUnusedFragments', // `graphql`@15
    'KnownFragmentNamesRule',
  ...
  relay: (0, _lodash2.default)(
    ...
    'NoUnusedFragmentsRule', // `graphql` < 14
    'ProvidedNonNullArguments', // `graphql`@14
    'ProvidedRequiredArguments',
    'ScalarLeafs', // `graphql`@15
    'ProvidedRequiredArgumentsRule',
    'ScalarLeafsRule'
  ),
  literal: (0, _lodash2.default)(
    allGraphQLValidatorNames,
    'KnownFragmentNames',
    'NoUnusedFragments', // `graphql`@15
    'KnownFragmentNamesRule',
...
const rules = {
  'template-strings': {
    ...
    create: context =>
      (0, _createRule.createRule)(context, optionGroup => parseOptions(optionGroup, context)),
  },
  'named-operations': {
    meta: {
      schema: {
    ...
    create: context => {
      return (0, _createRule.createRule)(context, optionGroup =>
        parseOptions(
          {
...
const gqlProcessor = {
  ...
  postprocess: function (messages) {
    ...
    return (0, _lodash.default)(messages).filter(message =>
      Object.keys(rules)
        .map(key => `graphql/${key}`)
